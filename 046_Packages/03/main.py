...
from packages import Registration,Product_Information,Generate_Invoice,add_products,display_profile
...
while True:
    ...
    match choice:
        case 1:
            ...
            Registration.customer(name,email,mobile)
        ...
        case 2:
            ...
            print("\nProduct Details are: ")
            Product_Information.product(name=p_name, price=p_price, category=p_categ)

        case 3:    
            p_namee=input("\nEnter Product Name : ")
            p_pricee=int(input("Enter Price : "))
            Generate_Invoice.invoice(p_namee, p_pricee)
        ...
        case 5:
            ...
            display_profile.profile(Name=namee, City=cityy, Mail=maill, Mobile=mobilee, Membership=typee)
