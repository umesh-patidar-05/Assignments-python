...
from mypackages import total,percent,grade,highest,lowest
...
while True:
    ...
    match choice:
        ...
        case 3:
            print("\nPercentage =",percent.percentage(marks))    
        ...
        case 5:
            ...
            print("\nTotal Marks :",total.total(marks))    
            print("Percentage  :",percent.percentage(marks))
            print("Grade       :",grade.grade(marks))
            print("Highest Mark:",highest.highest(marks))
            print("Lowest Mark :",lowest.lowest(marks))

        case 6:
            print("\nHighest Mark =",highest.highest(marks))

        case 7:
            print("\nLowest Mark =",lowest.lowest(marks))        
